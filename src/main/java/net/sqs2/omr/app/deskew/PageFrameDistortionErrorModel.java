...
public class PageFrameDistortionErrorModel extends PageImageErrorModel implements Serializable {
	...
	public PageFrameDistortionErrorModel(){
	}
	
	public PageFrameDistortionErrorModel(int errorType, float distortion) {
