...
public class ImageTranslationFilter{
	...
	int defaultBackgroundColor = 0x00000000;
	
	public ImageTranslationFilter(BufferedImage image, Point2D[] deskewMasterPoints, Point2D[] deskewImagePoints, int defaultBackgroundColor) {
		this(image, deskewMasterPoints, deskewImagePoints);
		this.defaultBackgroundColor = defaultBackgroundColor;
	}
	
	private ImageTranslationFilter(BufferedImage image, Point2D[] deskewMasterPoints, Point2D[] deskewImagePoints) {
