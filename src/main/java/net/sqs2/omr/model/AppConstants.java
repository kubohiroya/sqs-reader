...
public class AppConstants {
	...
	public static final String TASK_EXECUTION_ERROR_SOUND_FILENAME = _("MarkReaderConstants.TASK_EXECUTION_ERROR_SOUND_FILENAME"); //$NON-NLS-1$
	...
	public static final String SESSION_FANFARE_SOUND_FILENAME = _("MarkReaderConstants.SESSION_FANFARE_SOUND_FILENAME"); //$NON-NLS-1$
