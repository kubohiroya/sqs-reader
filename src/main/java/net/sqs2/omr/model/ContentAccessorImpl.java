...
public class ContentAccessorImpl implements Serializable, ContentAccessor {
	...
	public ContentAccessorImpl(File rootDirectory) throws IOException {
		...
		this.pageMasterAccessor = FormMasterAccessor.getInstance(rootDirectory);
	...
	public void close() throws IOException{
		this.pageMasterAccessor.shutdown();
		this.pageTaskAccessor.shutdown();
		this.rowAccessor.shutdown();
