...
public class MarkReaderConstants {
	...
	public static final int CLIENT_TIMEOUT_SEC = 30;// Integer.parseInt(MarkReaderConstants.getResourceBundle().getString("service.client.timeout"));
	...
	public static final int SESSION_SOURCE_ADVERTISE_DELAY_IN_SEC = 2;// sec

	public static final long SESSION_SOURCE_NEWFILE_IGNORE_SEC_THRESHOLD_IN_SEC = -1L;
	//public static final long SESSION_SOURCE_NEWFILE_IGNORE_SEC_THRESHOLD_IN_SEC = 10L;
	
	public static final int MULTICAST_PORT = 1091;// FIXME: configurable port

	// public static final String DEFAULT_SOURCEDIRECTORY_PATH =
