...
public class FormArea implements Serializable {
	...
	public boolean isSelectSingle() {
		return this.typeCode == FormArea.SELECT_SINGLE;
	}

	public boolean isSelectMultiple() {
		return this.typeCode == FormArea.SELECT_MULTIPLE;
	}
	...
	public boolean isMarkArea() {
		return this.typeCode == FormArea.SELECT_SINGLE || this.typeCode == FormArea.SELECT_MULTIPLE;
	}

	public boolean isBarcode() {
		return this.typeCode == FormArea.BARCODE;
	}
