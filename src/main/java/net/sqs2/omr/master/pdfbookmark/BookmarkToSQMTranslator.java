...
public class BookmarkToSQMTranslator extends XSLTranslator {
	public BookmarkToSQMTranslator(String baseURI, String[] xsltFilenames,
			Map<String, ParamEntry[]> xsltParamEntryArrayMap)
			throws TranslatorException {
		super(baseURI, xsltFilenames, xsltParamEntryArrayMap);
	}
