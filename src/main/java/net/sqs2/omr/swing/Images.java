...
public class Images {
	...
	/*
	 * static{ URL.setURLStreamHandlerFactory(new
	 * ClassURLStreamHandlerFactory()); }
	 */

	// private static Map<Icon,BufferedImage[]> icon2ImageArrayMap = new
	// ConcurrentHashMap<Icon,BufferedImage[]>();
	public static final ImageIcon PAGE_EXCEL_ICON = ImageManager.createImageIcon("page_excel.png");
	public static final ImageIcon PAGE_WHITE_EDIT_ICON = ImageManager.createImageIcon("page_white_edit.png");
	public static final ImageIcon CHART_PIE_ICON = ImageManager.createImageIcon("chart_pie.png");

	public static final ImageIcon ACCEPT_ICON = ImageManager.createImageIcon("accept.png");
	public static final ImageIcon CANCEL_ICON = ImageManager.createImageIcon("cancel.png");
	public static final ImageIcon TAG_YELLOW_ICON = ImageManager.createImageIcon("tag_yellow.png");
	public static final ImageIcon TAG_ORANGE_ICON = ImageManager.createImageIcon("tag_orange.png");
	...
	// public static final ImageIcon OPEN24_ICON =
	// ImageManager.createImageIcon("Open24.gif");
	...
	public static final ImageIcon DND_HERE_ICON = ImageManager.createImageIcon(AppConstants.MAIN_ICON);
}
