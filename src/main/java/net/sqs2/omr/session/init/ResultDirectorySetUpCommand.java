...
public class ResultDirectorySetUpCommand implements Callable<Boolean>{
	/**
	 * 
	 */
	File sourceDirectoryRootFile;
	public ResultDirectorySetUpCommand(File sourceDirectoryRootFile){
	...
	public Boolean call()throws IOException{
		...
		ConfigFileUtil.createConfigFileIfNotExists(this.sourceDirectoryRootFile);
		return Boolean.TRUE;
	}
