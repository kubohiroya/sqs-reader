...
import net.sqs2.omr.session.daemon.ServerDispatcherImpl;
...
public class SessionSourceServerDispatcherImpl extends ServerDispatcherImpl implements SessionSourceServerDispatcher{
	...
	public SessionSourceServerDispatcherImpl(LocalSessionSourceServer localSessionService, RemoteSessionSourceServer remoteSessionService, long key){
