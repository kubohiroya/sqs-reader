...
public class PageEvent extends TraverseEvent {
	RowEvent rowEvent;
	FormMaster master;
	int pageIndex;
	PageTask pageTask;
	...
	enum ERROR_TYPE {
		NONE, PAGEFRAME_RECOG_ERROR, PAGEORDER_RECOGMARK_INVALID, PAGE_UPSIEDE_DOWN
	}

	ERROR_TYPE errorType = ERROR_TYPE.NONE;

	public PageEvent(RowEvent rowEvent, FormMaster master) {
